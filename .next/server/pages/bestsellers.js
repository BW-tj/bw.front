        ...
        const getProducts = async ()=>{
            try {
                ...
                if (user.isAuth) config = {
                    headers: {
                        'Authorization': 'Bearer ' + user.isAuth ? localStorage.getItem("bw-client-token") : 0
                    }
                };
                const productsRes = await fetch("https://api.chistayaliniya.tj/api" + '/product/filtration?tag=3', config);
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((next_head__WEBPACK_IMPORTED_MODULE_2___default()), {
                children: [
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("title", {
                        children: "Хит продаж большой стирки"
                    }),
...
var __webpack_exports__ = __webpack_require__.X(0, [730,61,168,914], () => (__webpack_exec__(3199)));
