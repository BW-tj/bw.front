    ...
    <div className={styles.root}>
      <div className={styles.container}>
        <div className={styles.bw}>
          <div className={styles.bw__title}>Онлайн магазин «Чистая линия»</div>
        ...
        <div className={styles.socialMedia}>
          <div className={styles.socialMedia__title}>Мы в социальных сетях</div>
        ...
        <div className={styles.aboutUs}>
          ...
          <div className={styles.aboutUs__text}>{data.about}</div>
        </div>
      </div>

      <div
        className={styles.copyriht}
        style={{ display: "flex", flexWrap: "wrap" }}
      >
        <div className={styles.container}>
          © 2022 Чистая линия. Все права защищены.
        </div>
        <div className={styles.container}>ООО «Алиф Технология» © 2022</div>
      </div>
    </div>
  );
};
