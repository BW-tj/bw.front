  ...
  return (
    <div className={styles.wrap}>
      <If condition={isSearchFocused}>
        <span
          className={styles.search_cover}
          onClick={() => setSearchFocued(false)}
        ></span>
      </If>
      <If condition={isCatergoryOpen && !isSearchFocused}>
        <span
          className={styles.category_cover}
          onClick={() => setCatergoryOpen(false)}
        ></span>
      </If>
      ...
      <div className={classNames(styles.root, styles.not_scrolling)}>
        ...
        <CategoryList
          open={isCatergoryOpen}
          onClose={() => setCatergoryOpen(false)}
        />
